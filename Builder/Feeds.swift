...
func blog(_ items: [FeedItem]) -> Node {
  ...
  return feed([
    ...
    link([
      href("https://gofake1.net/blog/feed.atom"), rel("self"),
      type("application/atom+xml")
    ]),
    link([
      href("https://gofake1.net/blog/"), rel("alternate"), type("text/html"),
      hreflang("en-US")
    ]),
...
func cse40175(_ items: [FeedItem]) -> Node {
  ...
  return feed([
    ...
    link([
      href("https://gofake1.net/cse40175/feed.atom"), rel("self"),
      type("application/atom+xml")
    ]),
    link([
      href("https://gofake1.net/cse40175/"), rel("alternate"),
      type("text/html"), hreflang("en-US")
    ]),
